// ============================================
// CORRIDA E-K-F PRO
// Estilo mais próximo de Subway Surfers / Temple Run
// Personagem animado + carros mais realistas
// ============================================
...
function startGame() {
    ...
    isPaused = false;
    playSound('start');
    messageEl.innerHTML = 'Você está correndo para frente!  |  <strong>P / ESC</strong> = Pausar';
    gameLoop();
}
...
function updateObstacles() {
    for (let i = obstacles.length - 1; i >= 0; i--) {
        ...
        if (obstacles[i].y > canvas.height + 40) {
...
// Função para escurecer a cor do carro
...
function gameLoop() {
    ...
    if (frameCount % Math.max(20, 60 - Math.floor(speed * 2.5)) === 0) {
        spawnObstacle();
    }
...
function drawStartScreen() {
    drawRoad();
    drawPlayer();
    messageEl.innerHTML = 'Pressione <strong>ESPAÇO</strong> ou qualquer <strong>SETA</strong> para começar!<br>Você vai correr em direção aos obstáculos';
}
