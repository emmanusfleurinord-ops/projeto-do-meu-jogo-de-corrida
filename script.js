// ============================================
// CORRIDA F-E-K
// Só carros descendo + Tela Cheia (tecla F)
// Som de colisão: Aiiie / Óóóóó
// ============================================
...
function playSound(type) {
    try {
        ...
        if (type === 'start') {
            ...
            osc1.frequency.exponentialRampToValueAtTime(180, audioCtx.currentTime + 0.55);
            gain1.gain.setValueAtTime(0.28, audioCtx.currentTime);
            gain1.gain.exponentialRampToValueAtTime(0.01, audioCtx.currentTime + 0.55);
            osc1.start();
            osc1.stop(audioCtx.currentTime + 0.55);

            // Segunda camada (deixa mais gritante)
            ...
            osc2.frequency.exponentialRampToValueAtTime(90, audioCtx.currentTime + 0.4);
...
function gameLoop() {
    ...
    if (checkCollision()) {
        gameOver = true;
        gameRunning = false;
        playSound('crash');   // <-- aqui toca o "Aiiie / Óóóóó"
